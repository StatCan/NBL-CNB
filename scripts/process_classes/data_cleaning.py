...
class CleanData:
    ...
    def __init__(self, add_pts: gpd.GeoDataFrame, bld_polys: gpd.GeoDataFrame, parcels: gpd.GeoDataFrame) -> None:
    ...
    def __call__(self,):
        ...
        self.parcels = reproject(self.parcels, proj_crs)
        ...
        self.parcels.to_file(project_gpkg, layer='parcels_cleaned', driver='GPKG')
        ...
        addresses = gpd.sjoin(addresses, self.parcels[['link_field', 'geometry']], op='within', how='left')
        ...
        addresses_plural_sj = return_smallest_match(addresses_plural_sj, self.parcels, 'CIV_ID')
        ...
        cutter = PolygonCutter(footprint, self.parcels, crs=4326, proj_crs=int(proj_crs))
        footprint = cutter.bp
        ...
        footprint = gpd.sjoin(footprint, self.parcels[['link_field', 'geometry']], how='left', op='within')
        ...
        footprint_plural_sj = return_smallest_match(footprint_plural_sj, self.parcels, 'bf_index')
        footprint = footprint_singular.append(footprint_plural_sj)

        footprint = shed_flagging(footprint, addresses, self.parcels)

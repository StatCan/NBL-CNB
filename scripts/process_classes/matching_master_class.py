...
class Matcher:
    ...
    def __init__(self, address_data:gpd.GeoDataFrame, footprint_data:gpd.GeoDataFrame, proj_crs:int, footprint_join_field:str='link_field', address_join_field:str='link_field', shed_flag_field:str='shed_flag', bp_threshold:int=20, bp_area_threshold:int=20, buffer_size:int=20 ) -> None:
    ...
    def __call__(self) -> None:
        ...
        if len(addresses_bp) > 0:
            ...
            addresses_bp['u_areaflag'] = addresses_bp['footprint_index'].apply(lambda x: self.building_area_theshold_id(self.footprint[self.footprint['footprint_index'].isin(x)], self.bp_area_threshold)) 
    ...
    def _building_area_theshold_id(self, building_gdf:gpd.GeoDataFrame, bf_area_threshold , area_field_name='bf_area') -> bool:
        '''

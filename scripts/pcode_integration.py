...
gnb_co = r'C:\projects\point_in_polygon\data\NB_data\PCODE\Geonb_addresses.csv'
co_link_field = 'TmpUID'

# PCODE output
PCODE_file_path = r'C:\projects\point_in_polygon\data\NB_data\PCODE\excel'
pan_PCODE_lyr_nme = 'Addmatch_hlpan_204n_inventory.xlsx'
...
PCODE_pan_df = pd.read_excel(os.path.join(PCODE_file_path, pan_PCODE_lyr_nme), usecols=PCODE_import_fields)

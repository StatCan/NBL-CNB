...
The NBL is the geospatial representation of every building in Canada and its associated features (e.g. building use, year built, building height).
...
In order to achieve its vision the below processes were developed each with a goal of fulfilling a certain aspect of the NBL.
